...
$select = "SELECT * FROM `bookrequests` WHERE status=1 and studentno=$studentno";
                ...
                <div class="p-3">
                    <div class="row bg-info mr-2 p-3">
                        <div class="col text-white">
                            <h6>Books issued to the user</h6>
                        </div>
                        <!-- search area -->
                                ...
                                ?>
                                    ...
                                    ?></td>
                                        ...
                                        <?php
                                                ...
                                                if($return_status == 1)
                                                {
                                                    echo '<p><a href="approve_return.php?id='.$row["id"].'&status=0&bname='.$bname.'&studentno='.$studentno.'" class="btn btn-success">Returned book</a></p>';
                                                }

                                                else
                                                {
                                                    echo '<p><a href="approve_return.php?id='.$row["id"].'&status=1&bname='.$bname.'&studentno='.$studentno.'" class="btn btn-danger">Not returned yet</a></p>';
                                                }
                                            ?>
                                        </td>

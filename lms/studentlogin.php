                ...
                <div class="col-lg-6 welcome">
                  <div class="content pt-5">
                    ...
                    <div class="msg">
                      ...
                      <p class="text-center text-light">Login to the Student Panel</p>
                    </div>
                  </div>
                </div>
                  ...
                  <form class="rounded shadow" action="conn.php" method="post" onsubmit="return validate()">
                    ...
                    <div class="form-group">
                      <label for="" class="text-white">Student number</label>
                        <input type="text" name="studentno" placeholder="Enter student number" class="form-control" required>
                    </div>
                    ...
                    <div class="form-group">
                        <center>
                            <button class="btn" name="studentlogin">Login</button>
                        </center>
                    </div>
                    <a href="password_reset.php" class="text-primary">Forgot password?</a>
                    <p class="text-white">Already have no account, <a href="register.php?data="><b><i>Register here</i></b></a></p>
                </form>
                </div>
            </div>
        </div>
